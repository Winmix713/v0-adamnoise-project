...
import { EnhancedOverview } from "@/components/customers/enhanced-overview"
      ...
      <div className="flex flex-col gap-6">
        <AnimatedCard delay={0} className="p-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            <h1 className="text-2xl font-bold tracking-tight">Enhanced Customer Overview</h1>
            <p className="text-sm text-muted-foreground">Implemented with next-themes, framer-motion, and date-fns</p>
          </div>
        </AnimatedCard>
